...
RADIATOR_PRODUCTS = {
    ...
    "50×90 سانت": 8400000,
    "50×110 سانت": 9600000,
    "50×150 سانت": 12400000,

    "60×80 سانت": 9200000,

    "90×110 سانت": 13800000,
    "90×150 سانت": 17200000,
    "90×200 سانت": 22800000,

    "50×200 سانت": 15800000,
    "60×150 سانت": 14600000
}
...
# ==================== پیش فاکتور دستی رادیاتور ====================
    ...
    RADIATOR_PRODUCTS = {
        ...
        "90×90 سانت": 24500000,
        "50×90 سانت": 16800000,
        "50×110 سانت": 18500000,
        "50×150 سانت": 23500000,
        "60×80 سانت": 17500000,
        "90×110 سانت": 26500000,
        "90×150 سانت": 32000000,
        "90×200 سانت": 39500000,
    }
    ...
    def calculate_invoice(e):
        try:
            ...
            table.rows = [ft.DataRow(cells=[
                ...
                ft.DataCell(ft.Text(f"{line_total:,}"))
            ])]
    ...
    # فراخوانی اولیه برای وضعیت درست
    # (اگر بعداً مقدار پیش‌فرض داشت)

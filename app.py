            ...
            content=ft.Column([
                ...
                ft.Container(
                    content=ft.Column([
                        ...
                        ft.Text("نام و نام خانوادگی | نام کاربری", 
                        ...
                        ft.Container(
                            content=ft.Text(
                                ...
                                size=15, color="blue", text_align="center"
                            ),
                            bgcolor="#f0f0f0",
                            padding=12,
                            border_radius=12,
    ...
    def render(tab_index=0):
        ...
        if not page.session.logged_in:
                ...
                ft.Container(
                    content=ft.Column([
                        ...
                        ft.TextButton(
                            ...
                            on_click=lambda e: show_message("بخش ثبت‌نام / بازیابی رمز")
                        ),
                        ft.Container(
            ...
            contents = [
                ...
                ft.Column([
                    ft.Image(src="TopSUNify-1.png", width=200),
                    ft.Text("خانه اصلی", size=25, weight="bold")
                ], horizontal_alignment="center"),
            ...
            nav_bar = ft.Container(
                content=ft.Row([
                    ft.Container(content=ft.Image(src="dashboard.png", width=32, height=32), 
                               on_click=lambda _: render(0), padding=8),
                    ft.Container(content=ft.Image(src="invoice.png", width=32, height=32), 
                               on_click=lambda _: render(1), padding=8),
                    ft.Container(content=ft.Image(src="TopSUNify-1.png", width=32, height=32), 
                               on_click=lambda _: render(2), padding=8),
                    ft.Container(content=ft.Image(src="technical.png", width=32, height=32), 
                               on_click=lambda _: render(3), padding=8),
                    ft.Container(content=ft.Image(src="profile.png", width=32, height=32), 
                               on_click=lambda _: render(4), padding=8),
...
if __name__ == "__main__":
    ...
    ft.app(
        ...
        host="0.0.0.0",
        assets_dir="assets",
        # view=ft.WEB_BROWSER   # فقط برای تست محلی فعال کن
    )

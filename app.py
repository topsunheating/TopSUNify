...
RADIATOR_PRODUCTS = {
    "50×50 سانت": 6500000,
    "50×90 سانت": 8900000,
    "50×110 سانت": 10500000,
    "50×150 سانت": 13200000,
    "60×60 سانت": 7800000,
    "60×80 سانت": 9400000,
    "60×120 سانت": 12600000,
    "90×90 سانت": 13800000,
    "90×110 سانت": 15400000,
    "90×150 سانت": 18800000,
    "90×180 سانت": 21500000,
    "90×200 سانت": 23600000,
}
...
                if radiator_orientation.value and radiator_orientation.value != "-":
                    description += f" | {radiator_orientation.value}"
                table.rows = [ft.DataRow(cells=[ft.DataCell(ft.Text(description)), ft.DataCell(ft.Text(str(qty))), ft.DataCell(ft.Text(f"{line_total:,}"))])]

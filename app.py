...
# ==================== صفحه پیش فاکتور رادیاتور ====================
    ...
    return ft.Container(
        content=ft.Column([
            ...
            total_text,
            ft.FilledButton("صدور PDF نهایی", icon=ft.Icons.PICTURE_AS_PDF, width=350, bgcolor="green", 
                            on_click=lambda e: show_message(f"در حال تولید PDF برای {len(invoice_items)} ردیف..."))

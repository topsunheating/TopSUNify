...
def main(page: ft.Page):
            ...
            tabs=[
                ft.Tab(
                    ...
                    content=ft.Column([
                        ...
                        ft.FilePicker(label="انتخاب فایل DWG/DXF", on_result=lambda e: show_message("فایل آپلود شد - در حال پردازش...", "blue")),
                        ft.ElevatedButton("شروع تحلیل و صدور پیش‌فاکتور", bgcolor="#1565C0", color="white", width=350)
    ...
    # بقیه توابع (commission_page, credit_page, ...) را از کد قبلی خودتان کپی کنید

...
def profile_page():
        return ft.Container(content=ft.Column([
            ...
            ft.Container(content=ft.Column([
                # اصلاح شده: استفاده از lambda برای باز کردن دیالوگ و به‌روزرسانی صفحه
                ft.ListTile(leading=ft.Icon(ft.Icons.PERSON_ADD, color="blue"), title=ft.Text("درخواست ایجاد حساب"), trailing=ft.Icon(ft.Icons.ARROW_FORWARD_IOS, size=20), on_click=lambda e: (setattr(page, 'dialog', account_dlg), setattr(account_dlg, 'open', True), page.update())), 
